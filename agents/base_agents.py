...
class ActionPlanningAgent:
    ...
    def extract_steps_from_prompt(self, prompt: str) -> list:
        system = (
            ...
            "- If the user message contains a product specification - indicated by a "
            "'Product specification:' header, a structured list of capabilities, or "
            "equivalent product description content - do NOT include a step to request "
            "the specification. Begin directly with the first substantive step.\n"
